        ...
        <View style={styles.qualityInfoSection}>
          ...
          <View style={styles.qualityCard}>
            ...
            <Text style={styles.qualityDescription}>
              Highest quality grade with superior appearance, minimal defects, and excellent market value.
            </Text>
          </View>
          ...
          <View style={styles.qualityCard}>
            ...
            <Text style={styles.qualityDescription}>
              Good quality grade with acceptable appearance and minor defects, widely accepted in markets.
            </Text>
          </View>
          ...
          <View style={styles.qualityCard}>
            ...
            <Text style={styles.qualityDescription}>
              Specialty white variety with unique market demand and specific pricing patterns.
            </Text>
          </View>
        </View>
